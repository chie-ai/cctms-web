<template>
  <div class="a-width-100">
    <Header />
    <Alert />
    <UserRecords userType="health care staff" />
    <UserForm v-if="addForm" userType="health care staff" />
    <UserProfile v-if="userProfile" />
    <Covid19RecordManagement v-if="covid19RecordManagement" userType="health care staff"/>
