<template>
  <div class="a-width-100">
    <Header />
    <Alert />
    <UserRecords userType="covid-19 case" />
    <UserForm v-if="addForm" userType="covid-19 case" />
    <UserProfile v-if="userProfile" />
    <Covid19RecordManagement v-if="covid19RecordManagement" userType="covid-19 case"/>
