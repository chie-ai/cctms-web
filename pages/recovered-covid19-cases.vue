<template>
  <div class="a-width-100">
    <Header />
    <Alert />
    <UserRecords userType="recovered covid-19 case" />
    <UserForm v-if="addForm" userType="recovered covid-19 case" />
    <UserProfile v-if="userProfile" />
    <Covid19RecordManagement v-if="covid19RecordManagement" userType="recovered covid-19 case"/>
